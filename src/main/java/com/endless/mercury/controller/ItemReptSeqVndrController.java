...
public class ItemReptSeqVndrController 
{
 ...
 // Delete a ItemReptSeqVndr
    ...
    public ItemReptSeqVndr updateItemReptSeqVndr(@PathVariable(value = "id") Long itemReptSeqVndrId,
        ...
        itemReptSeqVndr.setChildItemFor(itemReptSeqVndrDetails.getChildItemFor());
        itemReptSeqVndr.setChildItemId(itemReptSeqVndrDetails.getChildItemId());
        itemReptSeqVndr.setChildItemPriority(itemReptSeqVndrDetails.getChildItemPriority());
        itemReptSeqVndr.setChildItemSequenceNo(itemReptSeqVndrDetails.getChildItemSequenceNo());
        ...
        itemReptSeqVndr.setReceipeVendorFlowId(itemReptSeqVndr.getReceipeVendorFlowId());
        itemReptSeqVndr.setStockSharingPrecentage(itemReptSeqVndr.getStockSharingPrecentage());
        itemReptSeqVndr.setUom(itemReptSeqVndr.getUom());
        itemReptSeqVndr.setUpdatedBy(itemReptSeqVndr.getUpdatedBy());
        itemReptSeqVndr.setVendorId(itemReptSeqVndr.getVendorId());
